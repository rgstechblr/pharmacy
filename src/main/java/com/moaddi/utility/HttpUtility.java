...
public class HttpUtility {
    ...
    public static void main(String[] args) {
    	String msg="again test message from bang";
    	String country="91";
    	String mobileNos="919916272636";
    	...
    	try {
            ...
            //String requestURL="http://sms.bestsmsdeal.in/api/sendhttp.php?authkey="+authkey+"&mobiles="+mobileNos+"&message="+URLEncoder.encode(msg, "UTF-8")+"&sender="+sender+"&route="+route+"&country="+country;
