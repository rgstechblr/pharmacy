...
var acckind_arr = new Array("Company", "Agency", "Operator","Charger","Partner","Customer");
...
function print_accountName(accountName, selectedIndex){
    ...
    option_str.length=0;    
    option_str.options[0] = new Option('All','All');
...
function print_accountKind(accountKind){
    ...
    option_str.length=0;
    option_str.options[0] = new Option('All  Kinds of Account','ALL');
    option_str.selectedIndex = 0;
