 ...
 <!-- Navigation -->
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="height:600px;background-color:#C1C1C1;padding-top:10px;margin-top:80px;">
                    <li class="active">
                   ...
                   <li class="dropdown">
                         ...
                         <ul class="dropdown-menu">
                         <li>
                        	<a href="createaccount.htm?u=Manager"><i class="fa fa-fw fa-bar-chart-o"></i> Create Manager</a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a href="createaccount.htm?u=Warehouse""><i class="fa fa-fw fa-edit"></i> Create Warehouse</a>
                       </li>
                        </ul>
                    </li>
                    <li>
