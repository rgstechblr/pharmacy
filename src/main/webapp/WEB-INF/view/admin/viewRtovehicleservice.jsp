...
<!-- row  -->
   ...
   <div id="no-more-tables">
     ...
     <form:form action="" method="post" onsubmit="return validate(this);">     
 ...
 function validate(formObj)
	{
		if(document.getElementById('vehicleName').value=="")
	   {
		 ...
		 alert(" enter your vehicle name");
       document.getElementById('vehicleName').focus();
		  return false;
		}
		else if(document.getElementById('vehicleYear').value=="")
		{
			 
			 alert("enter your vehicle year");
	          document.getElementById('vehicleYear').focus();
			  return false;
		}
		
		else if(document.getElementById('issues').value=="")
		{
			 
			 alert("Enter the Vehicle Problem");
		...
		else if(document.getElementById('comment').value=="")
		{
			 ...
			 alert("Enter the Vehicle Current Status");
