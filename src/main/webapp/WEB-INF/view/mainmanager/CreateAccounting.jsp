...
<form action="createaccount.htm" method="post" enctype="multipart/form-data" onsubmit="return validate(this);">
   ...
   <div class="col-xs-5 col-md-2">
        <div class="form-group">
        	...
        	<input type="hidden" name="userRole" id="userRole" value="Accounting"/>
           <input type="submit" class="btn btn-lableinfo btn-pressure btn-sensitive" id="btnSubmit" value="Create Accounting" />
         </div>
