...
<script>
	...
	$('#btnCheck').click(
		...
		$('#btnView').click(
		function(event) {
			window.location="viewaccount.htm?cid="+$("#customerId").val()+"&uid="+$("#userRoleId").val();
		});
...
<form action="updateaccountstatus.htm" method="post">
   ...
   <div class="row">
      <div class="col-xs-5 col-md-2" align="right">
     <label for="concept" class="col-xs-5 col-md-3 control-label" hidden="true"> Full&nbsp;Name</label>
   </div>
   <div class="col-xs-5 col-md-6">
        <div class="form-group">
          <input type="text" class="ctextbox" name="fullName" id="fullName"  size="25" readonly="readonly" />
