  ...
  <!--  <div class="row">
   ...
   <div class="col-xs-8 col-md-8">
        <div class="form-group">
            <label for="concept" class="btn btn-titlelableinfo btn-pressure btn-sensitive" >To &nbsp;create &nbsp;new&nbsp; Administration he should be golden &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br/>customer and he should confirm to be Administration
 </label>
         </div>
...
<form action="createaccount.htm" method="post" enctype="multipart/form-data" onsubmit="return validate(this);">
   ...
   <div class="col-xs-5 col-md-2">
        <div class="form-group">
        	...
        	<input type="hidden" name="userRole" id="userRole" value="Administration"/>
           <input type="submit" class="btn btn-lableinfo btn-pressure btn-sensitive" id="btnSubmit" value="Create Administration" />
         </div>
